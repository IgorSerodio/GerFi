...
export default function Triage() {
  ...
  const categories = [
    ...
    { id: "SJOA", name: "SÃO JOÃO", description: "Eventos e Autorizações", icon: Ticket, color: "bg-blue-500" },
    ...
    { id: "SSAN", name: "SEMANA SANTA", description: "Eventos e Autorizações", icon: Ticket, color: "bg-emerald-500" },
        ...
        <aside className="w-80 bg-white border-r border-emerald-50 flex flex-col p-6 overflow-hidden">
          ...
          <div className="mt-6 pt-6 border-t border-emerald-50">
            <div className="bg-sefaz-dark rounded-2xl p-4 text-white">
              ...
              <p className="text-sm font-bold">Triagem Central 01</p>
            </div>
          </div>
        </aside>
