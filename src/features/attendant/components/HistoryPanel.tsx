...
export default function HistoryPanel({
  ...
  return (
    <div className="bg-white rounded-[40px] shadow-sm border border-emerald-100 p-8">
      ...
      <div className="flex overflow-x-auto gap-4 pb-2 snap-x">
        {personalHistory.map((h) => (
          <button
            ...
            className="shrink-0 w-[180px] text-left flex flex-col justify-between items-start p-4 bg-emerald-50/50 rounded-2xl border-2 border-emerald-50 hover:border-emerald-200 hover:bg-emerald-100/30 transition-all group cursor-pointer min-h-[120px] snap-start"
          >
            <div>
