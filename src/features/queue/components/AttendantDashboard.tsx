...
export default function AttendantDashboard({ session, initialQueue, initialHistory }: AttendantDashboardProps) {
  ...
  const [allowedServices, setAllowedServices] = useState<string[]>(session?.user?.services || []);
