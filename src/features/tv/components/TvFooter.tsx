...
export default function TvFooter({ tvSettings }: TvFooterProps) {
  ...
  return (
    <footer className="bg-emerald-950 text-white h-[8vh] rounded-[1vw] flex items-center overflow-hidden shrink-0 border-t border-white/5 shadow-2xl px-[2vw]">
      <div className="flex-1 overflow-hidden relative z-10 h-full flex items-center">
        <div className="animate-marquee whitespace-nowrap text-[4vh] font-bold opacity-90 uppercase tracking-tight inline-flex flex-row flex-nowrap shrink-0 items-center gap-[5vw] w-max">
